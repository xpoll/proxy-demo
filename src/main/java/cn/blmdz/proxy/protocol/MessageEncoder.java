...
public class MessageEncoder extends MessageToByteEncoder<Message2> {

    private static final int LENGTH_SIZE = 1;
    private static final int TYPE_SIZE = 1;

    @Override
    protected void encode(ChannelHandlerContext ctx, Message2 msg, ByteBuf out) throws Exception {
